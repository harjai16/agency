...
const SocialShare = ({ 
        ...
        <div className="flex items-center gap-1.5">
          {socialButtons.map((button) => (
            <button
              ...
              className={`p-1.5 rounded-md text-gray-600 transition-colors ${button.color}`}
  ...
  return (
    <div className={`flex flex-col gap-3 ${className}`}>
      <p className="text-xs sm:text-sm font-medium text-gray-700">Share this page</p>
      <div className="flex flex-wrap items-center gap-2">
        {socialButtons.map((button) => (
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className={`flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 bg-white text-gray-700 text-xs sm:text-sm font-medium transition-colors ${button.color}`}
            aria-label={`Share on ${button.name}`}
          >
            {button.icon}
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 bg-white text-gray-700 text-xs sm:text-sm font-medium transition-colors hover:bg-gray-50 hover:text-gray-900"
          aria-label="Copy link"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
