...
const CaseStudies = () => {
  return (
    <Section
      id="work"
      aria-label="Case studies and recent work"
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10 md:mb-14">
        <div className="max-w-xl space-y-3">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-gray-900">
            A few ways we’ve helped teams
            <br className="hidden md:block" /> go from decks to deployed.
          </h2>
          <p className="text-sm md:text-base text-gray-500 max-w-lg">
            We work with product, growth and operations teams to design, build
            and launch AI-powered experiences that ship fast and stand up in production.
          </p>
        </div>
