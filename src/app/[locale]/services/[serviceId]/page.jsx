...
const ServiceDetailPage = () => {
  ...
  return (
    <main className="bg-white text-gray-900">
      ...
      <Section className="py-12 sm:py-16 md:py-20 bg-gray-50">
        <div className="max-w-fullhd mx-auto space-y-8">
          <motion.div {...fadeUp(0)} className="max-w-3xl text-center mx-auto">
            <p className="text-[11px] uppercase tracking-[0.2em] text-gray-500 mb-3">
              Pricing
            </p>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 mb-4">
            ...
            {serviceDetails.pricing.map((plan, index) => (
              <div
                ...
                className={`rounded-3xl border ${
                  index === 1
                    ? "border-emerald-200 bg-emerald-50/50 shadow-lg scale-105"
                    : "border-gray-100 bg-white/80"
                } backdrop-blur p-6 shadow-[0_14px_32px_rgba(15,23,42,0.04)] flex flex-col`}
              >
                {index === 1 && (
                  <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-100 px-3 py-1 text-[10px] uppercase tracking-[0.18em] text-emerald-700 mb-4 w-fit">
